    ...
    <div className='flex h-screen flex-col lg:grid lg:grid-cols-10'>
      ...
      <div className='lg:col-span-6  flex flex-1 flex-col p-12'>
        ...
        <header className='flex items-center justify-between'>
          <h1 className='w-52 sm:w-80 cursor-pointer text-xl font-extralight'>The{' '}
          <span className='font-extrabold underline decoration-pink-600/50'>DegodsRipoff</span>{' '}
          NFT MarketPlace</h1>
          <button className='rounded-full bg-red-600 px-4 py-2 text-xs font-bold text-white lg-px-5 lg:py-3'>Sign In</button>
        </header>
